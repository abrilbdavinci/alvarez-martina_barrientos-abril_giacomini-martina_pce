...
<div class="container">
    ...
    <div class="my-5">
        ...
        <div style="color: white;" class="d-flex justify-content-center flex-wrap mb-5">
            ...
            <div style="width: 17vw; height: 25vw; background-image: url('{{ asset('images/fondo2.jpg') }}');" class="text-center shadow-sm rounded-5 p-5 me-5 d-flex flex-column justify-content-center align-items-center">
                <img style="height: 9vw;" class="mb-5" src="{{ asset('images/icon2.svg') }}" alt="haircare">
                <p class="fw-bold">Haircare</p>
            </div>
            <div style="width: 17vw; height: 25vw; background-image: url('{{ asset('images/fondo.png') }}');background-size: cover;" class="text-center shadow-sm rounded-5 p-5 me-5 d-flex flex-column justify-content-center align-items-center">

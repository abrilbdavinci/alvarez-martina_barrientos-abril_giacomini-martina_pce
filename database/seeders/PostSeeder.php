...
class PostSeeder extends Seeder
{
    public function run(): void
    {
        DB::table('posts')->insert([
            ...
            "category" => "skincare",
            "image" => "posts/VMywfHlnfXUrRAXWkLYOrKI4ErEFffRpTEGpRW4P.jpg",
            "author" => "Kiana Murden",
            "created_at" => now(),
            "updated_at" => now(),
            ],
            [
            "title" => "Y el ‘skincare’ se hizo autocuidado: la piel sana es la gran tendencia de 2025",
            "content" => "El tratamiento de la piel se ha consolidado como un mercado dinámico y en auge con una lección emocional importante que prioriza el bienestar",
            "category" => "Cuidado de la piel",
            "image" => "posts/HjQMOkLpQZgF7TtblSENX7hob0ZoilY1vHNOqzYD.png",
            "author" => "Ana Morales",
            "created_at" => now(),
            "updated_at" => now(),
            ]
